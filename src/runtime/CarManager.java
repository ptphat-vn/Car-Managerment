...
public class CarManager {
    public static void main(String[] args) {
        ...
        String brandUrl = "C:\\Users\\Admin\\Desktop\\JAVA\\17-Van-pe-12-2-2022\\brands.txt";
        String carUrl = "C:\\Users\\Admin\\Desktop\\JAVA\\17-Van-pe-12-2-2022\\cars.txt";
        bl.loadFromFile(brandUrl);
        CarList cl = new CarList(bl);
        cl.loadFromFile(carUrl);
        
        Menu menu = new Menu("Car Mamagerment System Menu");
        menu.addNewOption("");
        ...
        menu.addNewOption(" a car based on its ID");
